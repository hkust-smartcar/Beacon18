...
#elif defined(K60_2018_BEACON_SLAVE)
#include "libsc/k60/config/2018_beacon_slave.h"

#elif defined(K60_2018_BEACON_MASTER)
#include "libsc/k60/config/2018_beacon_master.h"
