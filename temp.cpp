...
//					diff = chasing_speed - L_pid.GetSetpoint() + Dir_pid.Calc(target->center.first);
				...
				case avoid:
					...
					case turnleft: /////////need tune
						L_pid.SetSetpoint(70-speeddiff);
						R_pid.SetSetpoint(70);
						break;
					case turnright: /////////need tune
						L_pid.SetSetpoint(70);
						R_pid.SetSetpoint(70-speeddiff);
						break;
					case fastturnleft: /////////need tune
						L_pid.SetSetpoint(70-speeddiff-10);
						R_pid.SetSetpoint(70);
						break;
					case fastturnright: /////////need tune
						L_pid.SetSetpoint(70);
						R_pid.SetSetpoint(70-speeddiff-10);
						break;
					...
					case chase_grey:
						int diff_grey;
						diff_grey = Dir_pid.output(120, (*onptr)->center.first);
...
//		sprintf(data, "batt:%lf ",battery.GetVoltage());
		...
		}else if(rotate==1){writer_.WriteString("prepare");}else
			if(rotate==2){writer_.WriteString("preforming");}
