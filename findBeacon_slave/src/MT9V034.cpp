...
//Set resolution
	...
	RegSet(0x07, 0x0388);//Context A 388
	...
	RegSet(0xB0, 188*120);
	RegSet(0x1C, 0x0302);//0x1C  here is the way to regulate darkness :)
	...
	RegSet(0x24,0x001B);//Corrects pixel negative dark offset when global reset in R0x20[9] is enabled.
	...
	RegSet(0x0B,220);//0x0B Coarse Shutter IMAGEW Total // changed
